...
public fun gradleRunnerDebug(projectDir: File, initializer: GradleRunnerBuilder.() -> Unit = {}): BuildResult = gradleRunner(projectDir) {
...
public data class GradleTask(
    ...
    public companion object {
        public fun task(name: String, vararg options: String): GradleTask = GradleTask(task = name, options = linkedSetOf(*options))
